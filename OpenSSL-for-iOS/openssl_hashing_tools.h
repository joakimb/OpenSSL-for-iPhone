...
void openssl_hash_points2poly(const EC_GROUP *group, BN_CTX *bn_ctx, int num_coeffs, BIGNUM *poly_coeff[], const EC_POINT *p, int n, const EC_POINT *p_list_1[], const EC_POINT *p_list_2[]);
